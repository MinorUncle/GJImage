...
(
 ...
 void main()
 {
     ...
     CHECK_GL(gl_FragColor = vec4(baseColor.rgb * (1.0 - overlayColor.a) + setlum(setsat(overlayColor.rgb, sat(baseColor.rgb)), lum(baseColor.rgb)) * overlayColor.a, baseColor.a));
 }
);
#else
NSString *const kGPUImageHueBlendFragmentShaderString = SHADER_STRING
