...
{
    if (!(self = [self initWithBytes:bytesToUpload size:imageSize pixelFormat:GJYUVixelFormat420P type:GJPixelTypeUByte]))
    {
        return nil;
    }
...
{
    if (!(self = [self initWithBytes:bytesToUpload size:imageSize pixelFormat:pixelFormat type:GJPixelTypeUByte]))
    {
        return nil;
    }
